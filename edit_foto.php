...
<body background="./bg3.jpg" style="background-repeat: no-repeat; background-size: cover; background-position: center center;">
 <!-- NAVBAR -->
...
<div id="wrapper">
    <div id="header">
    <h1 style="color: WHITE">Edit Foto</h1>
    ...
    <form action="update_foto.php" method="post" enctype="multipart/form-data">
        ...
        <table>
            ...
            <tr>
                ...
                <td><input style="color: white;" type="file" name="lokasifile"></td>
            </tr>
            <tr>
