...
<br><br>
<h1>Edit Profil</h1>
    <form action="editprof.php" method="$_POST">
                ...
                ?>
                    <div class="category-item" style="margin-top: 20px; margin-bottom: 20px;">
                        <a href="galeri.php?kat=<?php echo $data['albumid'] ?>">
                         <center><h6>📷Judul Album</h6></center><p style="text-align: center;"><?php echo $data['namaalbum'] ?></p>
                         <center><h6>Deskripsi</h6></center><p style="text-align: left:"><?php echo $data['deskripsi'] ?></p>
                        </a>
                    </div>
