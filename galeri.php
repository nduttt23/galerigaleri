        ...
        <div class="container">
            ...
            <div class="box">
                ...
                <div class="slide">
                    ...
                    <div class="aksi">
                        <a href="like.php?fotoid=<?=$data['fotoid']?>" class="like"><i>❤</i></a>
                        <a href="komentar.php?fotoid=<?=$data['fotoid']?>" class="komentar">Komentar</a>
                        <a href="hapus_foto.php?fotoid=<?=$data['fotoid']?>" class="hapus"><i class="fas fa-trash-alt">Hapus</i></a>
                        <a href="edit_foto.php?fotoid=<?=$data['fotoid']?>">Edit</a>
                    </div>
                    <div class="info">
                        <p>Semua Like💕<?php echo mysqli_num_rows(mysqli_query($conn, "SELECT * FROM likefoto WHERE fotoid='{$data['fotoid']}'")); ?></p>
                        <p>Semua Coment💬 <?php echo mysqli_num_rows(mysqli_query($conn, "SELECT * FROM komentarfoto WHERE fotoid='{$data['fotoid']}'")); ?></p>
                    </div>
                </div>
                <?php 
                            } else {
